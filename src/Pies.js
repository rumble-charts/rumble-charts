...
class Pies extends React.Component {
    ...
    getPieWidth(x, props) {
        ...
        if (pieWidth) {
            ...
            if (props.combined) {
                ...
                let seriesCount = _isEmpty(props.series) ? 1 : props.series.length;
    ...
    renderArc(startAngle, endAngle, radius, pieWidth, seriesIndex, pointIndex, point) {
        ...
        if (_isArray(fillColor) && _uniq(fillColor).length === 1) {
